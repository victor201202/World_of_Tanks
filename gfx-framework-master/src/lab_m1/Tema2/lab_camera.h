    ...
    class Camera
    {
     public:
        ...
        void MoveForward(float distance)
        {
            ...
            //position.x += -glm::sin(glm::degrees(rotation)) * dir.x * distance;
            //position.z += glm::cos(glm::degrees(rotation)) * dir.z * distance;
        }
        ...
        void TranslateForward(float distance)
        {
            ...
            //position.x += glm::sin(glm::degrees(rotation)) * glm::normalize(forward).x * distance;
            //position.z += glm::cos(glm::degrees(rotation)) * glm::normalize(forward).z * distance;
        }
        ...
        void RotateThirdPerson_OY(float angle)
        {
            ...
            /*glm::vec3 initialDirection = glm::vec3(0.0f, 0.0f, 1);
            glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::degrees(angle), glm::vec3(0.0f, 1.0f, 0.0f));
            ...
            glm::vec3 initialDirection = glm::vec3(0.f, 0.0f, 1.f);
            glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::degrees(rotation), glm::vec3(0.0f, 1.0f, 0.0f));
            glm::vec4 rotatedDirection = rotationMatrix * glm::vec4(initialDirection, 0.0f);
            glm::vec3 newDirection = glm::vec3(rotatedDirection);
